...
namespace LoodsmanCommon
{
    ...
    {
        /// <summary>
        /// Возвращает значение по заданному ключу, в случае отсутствия значения, возвращает значение по умолчанию.
        /// </summary>
        ...
        /// <summary>
        /// Некоторые методы сервера приложений возвращают значения типа object {short}, привидение такого типа к int будет ошибочным,
        /// так как вместо привидения будет использоваться операция распаковки.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает результат DataRow["_TYPE"].
        ...
        /// <summary>
        /// Возвращает результат DataRow["_DEFAULT"]. Использовать в случае когда поле содержит значение по умолчанию (string). 
